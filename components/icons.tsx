...
// Prototype-Specific Sidebar Icons
...
export const FolderIcon = ({ className }: any) => (
  <svg className={`w-5 h-5 ${className}`} fill="currentColor" viewBox="0 0 24 24">
    <path d="M20 18c0 1.105-.895 2-2 2H6c-1.105 0-2-.895-2-2V7c0-1.105.895-2 2-2h3.172a2 2 0 0 1 1.414.586l1.828 1.828A2 2 0 0 0 13.828 8H18c1.105 0 2 .895 2 2v8z" />
  </svg>
);

export const FolderCleanedIcon = ({ className }: any) => (
  <svg className={`w-5 h-5 ${className}`} fill="currentColor" viewBox="0 0 24 24">
    <path d="M13 13h-3v-3h3v3zm-3 5h3v-3h-3v3zm5-5h3v-3h-3v3zm0 5h3v-3h-3v3zM4 18V7c0-1.1.9-2 2-2h3.17c.4 0 .7.1.9.3L12 7.2l1.9-1.9c.2-.2.5-.3.9-.3H18c1.1 0 2 .9 2 2v11c0 1.1-.9 2-2 2H6c-1.1 0-2-.9-2-2z" />
  </svg>
);

export const FolderSafeIcon = ({ className }: any) => (
  <svg className={`w-5 h-5 ${className}`} fill="currentColor" viewBox="0 0 24 24">
    <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z" />
  </svg>
);

export const FolderVaultIcon = ({ className }: any) => (
  <svg className={`w-5 h-5 ${className}`} fill="currentColor" viewBox="0 0 24 24">
    <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM9 6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9V6zm9 14H6V10h12v10zm-6-3c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z" />
  </svg>
);

export const FolderLogsIcon = ({ className }: any) => (
  <svg className={`w-5 h-5 ${className}`} fill="currentColor" viewBox="0 0 24 24">
